...
namespace DAL.Migrations
{
    ...
    [Migration("20200423191233_AddedIdentityToProjectCoveringSubjectIDMigration")]
    partial class AddedIdentityToProjectCoveringSubjectIDMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.ExternalMentor", b =>
                {
                    b.Property<long>("CompanyID")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.ExternalMentorContact", b =>
                {
                    b.Property<long>("CompanyID")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("CompanyID", "MentorID", "SerialNumber");
            ...
            modelBuilder.Entity("Domain.ExternalMentorContact", b =>
                {
                    b.HasOne("Domain.ExternalMentor", null)
                        .WithMany("Contacts")
            ...
            modelBuilder.Entity("Domain.ProjectProposal", b =>
                {
                    ...
                    b.HasOne("Domain.ExternalMentor", "ExternalMentor")
                        .WithMany()
                        .HasForeignKey("ExternalMentorCompanyID", "ExternalMentorMentorID");
                });
